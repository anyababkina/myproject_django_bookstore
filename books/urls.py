...
urlpatterns = [
    ...
    path('books/<int:book_id>/', cache_page(60 * 2)(AboutBookView.as_view()), name='about_book'),
    path('author/<int:author_id>/', cache_page(60 * 2)(AboutAuthorView.as_view()), name='about_author'),
